...
1. Fetch boxscore.email/mlb's **current edition** (plain URL, no date — do not
   browse for a date). By the rule, it always holds yesterday's completed games;
   that is the slate you report. boxscore.email is authoritative; cross-check
   team affiliations on baseball-reference.com.
